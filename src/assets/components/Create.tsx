          ...
          <div className={`content ${isVisible ? "fade-in" : ""}`}>
            ...
            <div className="tabs-container">
              <button
                ...
                className={`tab-button ${activeTab === "second" ? "active-tab" : ""}`}
              >
                Crear Rutina
              </button>
              <button
                onClick={() => setActiveTab("first")}
                className={`tab-button ${activeTab === "first" ? "active-tab" : ""}`}
              >
                Ver Rutina
              </button>
              <button
                onClick={() => setActiveTab("third")}
                className={`tab-button ${activeTab === "third" ? "active-tab" : ""}`}
              >
                Consejos
              </button>
            </div>
              ...
              <div className="tab-content">
                ...
                <ul className="rutinas">
                  <li className="rutina">
                    ...
                    >
                      <img className="mini-img" src={biceps} alt="Biceps" /> Working on biceps
                    </button>
                  </li>
                  <li className="rutina">
                    <button
                    ...
                    >
                      <img className="mini-img" src={biceps} alt="Biceps" /> Barbell curl for biceps
                    </button>
                  </li>
                  <li className="rutina">
                    <button
                    ...
                    >
                      <img className="mini-img" src={biceps} alt="Biceps" /> Lifts on the block and
                      in simulators
                    </button>
                  </li>
                  <li className="rutina">
                    ...
                    >
                      <img className="mini-img" src={biceps} alt="Biceps" /> Lifting dumbbells for
                      biceps while standing
                    </button>
                  </li>
                  <li className="rutina">
                    <button
                      className="button"
                      onClick={() =>
                        addExercise("Hammer dumbbell lift")
                      }
                    >
                      <img className="mini-img" src={biceps} alt="Biceps" /> Hammer dumbbell lift
                    </button>
                  </li>
                </ul>
              </div>
