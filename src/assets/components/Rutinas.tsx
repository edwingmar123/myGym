              ...
              <div className="tab-content-container">
                {activeTab === "second" && (
                  <div className="tab-content">
                    ...
                    <p>
                      Organiza tus actividades diarias añadiendo ejercicios y
                      tiempo estimado para cada uno.
                    </p>
                  </div>
                )}
                ...
                {activeTab === "first" && (
                  <div className="tab-content">
                    <h4 className="t">Tus rutinas</h4>
                    <ul className="rutinas">
                      <li className="rutina">
                        <button className="button">
                          <Link to="/pullups">Pullups</Link>
                        </button>
                      </li>
                      <li className="rutina">
                        <button className="button">
                          <Link to="/legcor">Legorl</Link>
                        </button>
                      </li>
                      <li className="rutina">
                        <button className="button">
                          <Link to="/bicepcurl">Bicepcurl</Link>
                        </button>
                      </li>
                      <li className="rutina">
                        <button className="button">
                ...
                {activeTab === "third" && (
                  <div className="tab-content">
                    ...
                    <p>
                      Recuerda calentar antes de cada rutina, mantenerte
                      hidratado y escuchar a tu cuerpo.
                    </p>
                  </div>
                )}
              </div>
